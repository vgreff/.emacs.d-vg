...
PS1='$? $(if [ "$?" = "0" ]; then       echo -e "${YELLOW}✔${NC}"; else         echo -e "${RED}☹${NC} "; fi) \[\e]0;\u@\h: \w\a\]\[\e]1337;CurrentDir=${PWD}\a\]${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\] \n \[\033[1;33m\]!\! \[\033[00m\]➜ '
