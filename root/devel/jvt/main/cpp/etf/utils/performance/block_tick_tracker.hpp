/******************************************************************************
 *
 * Copyright (c) block_tick_tracker.hpp by Daniel Davidson
 *
 * All Rights Reserved. 
 *******************************************************************************/
/*! 
 ...
 * 
 */
#ifndef _ETF_UTILS_PERFORMANCE_BLOCK_TICK_TRACKER_H_
#define _ETF_UTILS_PERFORMANCE_BLOCK_TICK_TRACKER_H_

#include "etf/linux_specific/cpu_info.hpp"
#include "cycle.h"
...
// custom <Block_tick_tracker public header section>
    ...
    ~Block_tick_tracker() {
      ...
      if(outstream_) {
        ...
        etf::linux_specific::Cpu_info::Processor_list_t const& 
          processors(etf::linux_specific::Cpu_info::get_instance()->processors());
...
#endif // _ETF_UTILS_PERFORMANCE_BLOCK_TICK_TRACKER_H_
