/******************************************************************************
 *
 * Copyright (c) block_rusage_tracker.hpp by Daniel Davidson
 *
 * All Rights Reserved. 
 *******************************************************************************/
/*! 
 ...
 * 
 */
#ifndef _ETF_UTILS_PERFORMANCE_BLOCK_RUSAGE_TRACKER_H_
#define _ETF_UTILS_PERFORMANCE_BLOCK_RUSAGE_TRACKER_H_

#include "etf/utils/block_indenter.hpp"
...
std::ostream& operator<<(std::ostream& out, rusage const& item) {
  etf::utils::Block_indenter indenter;
...
#endif // _ETF_UTILS_PERFORMANCE_BLOCK_RUSAGE_TRACKER_H_
