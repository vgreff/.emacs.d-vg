/******************************************************************************
 *
 * Copyright (c) h5_random_access_store.hpp by Daniel Davidson
 *
 * All Rights Reserved. 
 *******************************************************************************/
/*! 
 ...
 * 
 */
#ifndef _ETF_H5_UTILS_H5_RANDOM_ACCESS_STORE_H_
#define _ETF_H5_UTILS_H5_RANDOM_ACCESS_STORE_H_
...
namespace utils {
  ...
  inline 
  char const* to_c_str(Store_open_type e) {
    char const* values[] = {
      "OPEN_CREATE",
      "OPEN_READ"
    };
  ...
  // Forward typedefs
  typedef boost::shared_ptr< H5::H5File > H5_file_ptr;
  ...
  */
  ...
  public:
    ...
    // Class typedefs
    typedef boost::shared_ptr< FL_PacketTable > FL_PacketTable_ptr;
...
// custom <H5_random_access_store public header section>
    ...
    inline void make_groups_in_path(std::string const& group_path) {
      ...
      Group_id_list_t group_ids;
      {
        ...
        ++it;
        for(; it != end; ++it) {
          std::string const& current_group(it->native());
...
#endif // _ETF_H5_UTILS_H5_RANDOM_ACCESS_STORE_H_
