/******************************************************************************
 *
 * Copyright (c) application_signal_handler.hpp by Daniel Davidson
 *
 * All Rights Reserved. 
 *******************************************************************************/
/*! 
 ...
 * 
 */
#ifndef _ETF_APP_SIG_HANDLER_APPLICATION_SIGNAL_HANDLER_H_
#define _ETF_APP_SIG_HANDLER_APPLICATION_SIGNAL_HANDLER_H_
...
namespace app_sig_handler {
  ...
  class Application_signal_handler :
    public etf::patterns::Singleton< Application_signal_handler< LOCK_TYPE, GUARD_TYPE > > 
  {
  public:
  ...
  protected:
    Application_signal_handler() :
      ...
      instance_mutex_() 
    {
      pantheios::log(PANTHEIOS_SEV_DEBUG, "Created Application_signal_handler(", 
  ...
  public:
    ~Application_signal_handler() {
      pantheios::log(PANTHEIOS_SEV_DEBUG, "Destroyed Application_signal_handler(", 
                     pantheios::hex_ptr(reinterpret_cast<void*>(this)),
                     pantheios::character(')'));
    }
...
// custom <Application_signal_handler public header section>
    ...
    void remove_handler(Handler_function_t const& handler) {
      GUARD_TYPE guard(instance_mutex_);
    }
...
// end <Application_signal_handler::ctor_default_init>
    ...
    friend class etf::patterns::Singleton_impl< Application_signal_handler >;
  };

} // namespace app_sig_handler
} // namespace etf
#endif // _ETF_APP_SIG_HANDLER_APPLICATION_SIGNAL_HANDLER_H_
