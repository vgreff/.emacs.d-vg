/******************************************************************************
 *
 * Copyright (c) api_initializer.hpp by Daniel Davidson
 *
 * All Rights Reserved. 
 *******************************************************************************/
/*! 
 ...
 * 
 */
#ifndef _ETF_PATTERNS_API_INITIALIZER_HPP_
#define _ETF_PATTERNS_API_INITIALIZER_HPP_
...
namespace patterns {
  ...
  public:
    ...
    typedef boost::shared_ptr< Functor_scope_exit < UNINIT_FUNC > > Functor_scope_exit_ptr;
   ...
   * etf::patterns::Api_initializer< VFUNC, VFUNC > 
   * registry = etf::patterns::Api_initializer< VFUNC,  VFUNC>
   * (&my_init, &my_uninit);
   * </code>
   */
