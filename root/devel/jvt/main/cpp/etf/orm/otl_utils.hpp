/******************************************************************************
 *
 * Copyright (c) otl_utils.hpp by Daniel Davidson
 *
 * All Rights Reserved. 
 *******************************************************************************/
/*! 
 ...
 * 
 */
#ifndef _ETF_ORM_OTL_UTILS_H_
#define _ETF_ORM_OTL_UTILS_H_

#include "etf/orm/orm.hpp"
#include "etf/utils/fixed_size_char_array.hpp"
...
// custom <Otl_utils pre class section>
  ...
  inline 
  std::string sql_quote(typename etf::utils::Fixed_size_char_array< ARRAY_SIZE > const& value) {
