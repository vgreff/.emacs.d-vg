/******************************************************************************
 *
 * Copyright (c) orm_to_string_table.hpp by Daniel Davidson
 *
 * All Rights Reserved. 
 *******************************************************************************/
/*! 
 ...
 * 
 */
#ifndef _ETF_ORM_ORM_TO_STRING_TABLE_H_
#define _ETF_ORM_ORM_TO_STRING_TABLE_H_

#include "etf/orm/orm.hpp"
#include "etf/utils/streamers/table/table.hpp"
#include <string>
...
// custom <Orm_to_string_table pre class section>
  ...
  inline void print_recordset_as_table(typename Recordset::Row_list_t const& recordset, std::ostream &out) {
    ...
    out << etf::utils::streamers::table::Table_streamer< String_table_t >(data, header);
  }
...
#endif // _ETF_ORM_ORM_TO_STRING_TABLE_H_
