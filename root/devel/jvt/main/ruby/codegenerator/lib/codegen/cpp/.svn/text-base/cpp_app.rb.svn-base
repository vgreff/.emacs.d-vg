  ...
  class Application
    ...
    def initialize(data={})
      ...
      [ 
       ...
       :folder, :standard_otl_logging, :unit_test
      ...
      @namespace = (data[:namespace] or [ 'etf', 'apps' ])
      if folder
      ...
      @cpp_path = build_path
      @app_includes << 'etf/app_sig_handler/application_signal_handler.hpp' if app_sig_handler
      if @log_pantheios_fe
        @app_includes << 'pantheios/frontend.h'
        @app_includes << 'etf/utils/pantheios_debug_log.hpp'
